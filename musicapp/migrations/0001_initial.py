    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='playlistuser', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Post',
            fields=[
                ...
                ('branded_image', models.ImageField(blank=True, upload_to='images')),
                ('slug', models.SlugField(blank=True, default='', max_length=200, unique=True)),
                ('status', models.CharField(choices=[('draft', 'Draft'), ('published', 'Published')], default='published', max_length=10)),
                ('upload_song', models.FileField(null=True, unique=True, upload_to='audio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('song', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='albumsong', to='musicapp.post')),
            ],
        ),
        migrations.CreateModel(
            name='PremiumUser',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='premiumuser', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='promotedsongs',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('songs', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='musicapp.post')),
            ],
            options={
